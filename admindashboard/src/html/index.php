      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="./index.php" class="text-nowrap logo-img">
            <img src="../assets/images/logos/seodashlogo-removebg-preview.png" >
          </a>
              ...
              <div class="row">
                <div class="col-md-3">
                  <div class="investor-box">
                    <h2>Users Details</h2>
                    <div class="flip-view">
                      <a href="./user.php">User<i class="fas fa-chevron-circle-right"></i></a>
                    </div>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="investor-box">
                    ...
                    <div class="flip-view">
                      <a href="./doctor.php">Add<i class="fas fa-chevron-circle-right"></i></a>
                    </div>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="investor-box">
                    ...
                    <div class="flip-view">
                      <a href="appointment_user.php">See Users <i class="fas fa-chevron-circle-right"></i></a>
                    </div>
                  </div>
                </div>
